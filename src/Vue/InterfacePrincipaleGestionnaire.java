...
public class InterfacePrincipaleGestionnaire extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btnExit.setOnAction(e -> {
            primaryStage.close();
            InterfaceLoginGestionnaire interfaceLogin = new InterfaceLoginGestionnaire();
            try {
    ...
    private void ouvrirGestionProduits(Stage primaryStage) {
        InterfaceProduitsG interfaceProduits = new InterfaceProduitsG();
