...
public class InterfaceProduits extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btnRetour.setOnAction(e -> retournerAInterfacePrincipale(primaryStage));
    ...
    private void rechercherProduit() {
        InterfaceRechercheProduit rechercheInterface = new InterfaceRechercheProduit();
    ...
    private void retournerAInterfacePrincipale(Stage primaryStage) {
        ...
        try {
            interfacePrincipale.start(primaryStage);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
