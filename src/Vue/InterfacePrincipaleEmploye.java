...
public class InterfacePrincipaleEmploye extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Actions des boutons
        btnProduits.setOnAction(e -> ouvrirGestionProduitsE(primaryStage));
        btnExit.setOnAction(e -> {
            primaryStage.close();
            InterfaceLoginEmploye interfaceLogin = new InterfaceLoginEmploye();
            try {
        ...
        VBox vBox = new VBox(20,btnProduits, btnExit);
    ...
    private void ouvrirGestionProduitsE(Stage primaryStage) {
        InterfaceProduitsE interfaceProduitsE = new InterfaceProduitsE();
        interfaceProduitsE.start(primaryStage);
    }
